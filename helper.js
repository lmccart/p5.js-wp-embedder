// console.log($('.p5'))
$('.p5').each(function(ind) {
  console.log($(this)[0].href);
  //$(this).parent().append('<iframe src="'+$(this)[0].href+'" width="600px" height="400px"></iframe>');
  $(this).parent().append('<div id="editor">function foo(items) {var x = "All this is syntax highlighted";return x;}</div>');
});
...
var examples = {
  init: function(file) {
    ...
    examples.editor = ace.edit('editor');
